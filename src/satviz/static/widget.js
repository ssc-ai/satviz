...
function _setupFullscreenOverlay(container, viewer, log) {
...
async function render({ model, el }) {
	...
	try {
		...
		var heightPx = (model.get('height_px') || 480);
		var container = _createContainer(root, heightPx);
		...
		_setupFullscreenOverlay(container, viewer, log);
